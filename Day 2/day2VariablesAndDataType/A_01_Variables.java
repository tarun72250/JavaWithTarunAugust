...
//		//Variables :- Variables are some containers for storing some data.
//		byte b = 1;
//		short s = 01;
//		int a = 10;
//		long l = 1234;
...
//		char ch = 'a';
		...
		*/
		...
		System.out.println(name);//Hrishabh
		...
		int num;//declaration
		num = 10;
		System.out.println("old num value :"+num);//10
		
		num =20;
		System.out.println("new num value :"+num);//20
		...
		final int xvar ;
		xvar=9;
		System.out.println(xvar);//9
		
		//xvar = 8;  // will generate an error: cannot assign a value to a final variable
		 ...
		 */
		String msg = "DebugShala";
		System.out.println("Hello " + msg);   // Hello DebugShala
		...
		int x3, y3, z3;
		x3 = y3 = z3 = 50;
		System.out.println(x3 + y3 + z3);//150
		...
		int timePerWeek = 50; //best way to write a name of any identifier
