...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		String str = "Tarun Rathore";//String literall
		//created in SCP
		
		String str1 = new String("From DebugShala");//String object
		//SCP + heap both
		
		
		str.concat(" From DebugShala.");
		System.out.println(str);//Tarun Rathore
		String res = str.concat(" From DebugShala.");
		System.out.println(res);//Tarun Rathore From DebugShala.
		...
		//1 length()
		        System.out.println("\n------length()-------");
				System.out.println(str.length());//return 13 char in a String
				
		//2 charAt()
		        System.out.println("\n------charAt()-------");
				System.out.println(str.charAt(4));//return n		
				
		//3 substring(3)
		        System.out.println("\n------substring(3)-------");
				System.out.println(str.substring(3));//un Rathore
		...
		//5 concat()
				...
				System.out.println(new_str);//Tarun Rathore From DebugShala
